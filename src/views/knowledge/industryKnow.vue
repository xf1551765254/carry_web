<template>
  <div class="el-main-content">
    <imgList class="knowCase-top" pageRouter="industryKnow" />
    <div class="knowCase-bottom">
      <el-row class="knowCase-typeList" type="flex" justify="space-between">
      ...
      <div class="" v-for="(item,index) in listCard" :key="index">
        <list-card :imgSrc="item.src" :title="item.title" :date="item.date" :contain="item.content" :isIndustry="true">
        </list-card>
      </div>
...
export default {
  ...
  data() {
    return {
      radio: '1',
      radioList: [
        { id: '1', label: '1', name: '全部文章' },
        { id: '2', label: '2', name: '生产工艺' },
        { id: '3', label: '3', name: '环境保护' },
        { id: '4', label: '4', name: '产品质量' },
      ],
      selectValue: '',
      selectOptions: [
        { value: '1', label: '最新' },
